...
import { Subscribe, useRequest, useStateSubject } from "webapp/utils";
import {
  Box,
  Card,
  CardContent,
...
import { MoreVert, OndemandVideoOutlined, PhotoOutlined } from "@mui/icons-material";
  ...
  return (
    <Card sx={{ width: "100%" }}>
      <CardHeader
        ...
        action={
          <BlobInfoCardActions blob={blob} actions={actions} />
        }
      />
